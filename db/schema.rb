...
ActiveRecord::Schema[7.0].define(version: 2022_06_27_071231) do
  ...
  create_table "peters", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_peters_on_email", unique: true
    t.index ["reset_password_token"], name: "index_peters_on_reset_password_token", unique: true
  end
