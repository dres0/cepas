...
class StrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strain" do
    assert_difference("Strain.count") do
      post strains_url, params: { strain: { avalaible: @strain.avalaible, name: @strain.name } }
    end
  ...
  test "should update strain" do
    patch strain_url(@strain), params: { strain: { avalaible: @strain.avalaible, name: @strain.name } }
